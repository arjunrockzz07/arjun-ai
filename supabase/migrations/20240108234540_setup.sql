...
AS $$
DECLARE
  project_url TEXT := 'https://hbwyvbgxzjichommabpz.supabase.co:8000';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imhid3l2Ymd4emppY2hvbW1hYnB6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczMzgyOTUxNiwiZXhwIjoyMDQ5NDA1NTE2fQ.q2P9uSZpA50bFwTvY7b7YH7DIdPDDarTTaSSG1PQj0E'; -- full access needed for http request to storage
